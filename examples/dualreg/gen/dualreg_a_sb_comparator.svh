//----------------------------------------------------------------------
// This File: dualreg_a_sb_comparator.svh
...
class dualreg_a_sb_comparator extends uvm_component;
  `uvm_component_utils(dualreg_a_sb_comparator)

  a_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(a_item) exp_ap;
  uvm_analysis_export   #(a_item) out_ap;
  uvm_tlm_analysis_fifo #(a_item) expfifo;
  uvm_tlm_analysis_fifo #(a_item) outfifo;
