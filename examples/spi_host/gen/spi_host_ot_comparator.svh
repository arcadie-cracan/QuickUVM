//----------------------------------------------------------------------
// This File: spi_host_ot_comparator.svh
...
class spi_host_ot_comparator extends uvm_component;
  `uvm_component_utils(spi_host_ot_comparator)

  regbus_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(regbus_item) exp_ap;
  uvm_analysis_export   #(regbus_item) out_ap;
  uvm_tlm_analysis_fifo #(regbus_item) expfifo;
  uvm_tlm_analysis_fifo #(regbus_item) outfifo;
