//----------------------------------------------------------------------
// This File: axi_write_comparator.svh
...
class axi_write_comparator extends uvm_component;
  `uvm_component_utils(axi_write_comparator)

  wr_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(wr_item) exp_ap;
  uvm_analysis_export   #(wr_item) out_ap;
  uvm_tlm_analysis_fifo #(wr_item) expfifo;
  uvm_tlm_analysis_fifo #(wr_item) outfifo;
