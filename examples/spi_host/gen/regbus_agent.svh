...
class regbus_agent extends uvm_agent;
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    if (!uvm_config_db#(regbus_cfg)::get(this, "", "cfg", cfg))
      `uvm_fatal("NOCFG", {"No regbus_cfg set for: ", get_full_name()})
    is_active = cfg.is_active;
    vif       = cfg.vif;
    if (is_active == UVM_ACTIVE) begin
      drv = regbus_driver::type_id::create("drv", this);
      sqr = regbus_sequencer::type_id::create("sqr", this);
    end
