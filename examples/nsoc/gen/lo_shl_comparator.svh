//----------------------------------------------------------------------
// This File: lo_shl_comparator.svh
...
class lo_shl_comparator extends uvm_component;
  `uvm_component_utils(lo_shl_comparator)

  lo_s_item#(8) exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(lo_s_item#(8)) exp_ap;
  uvm_analysis_export   #(lo_s_item#(8)) out_ap;
  uvm_tlm_analysis_fifo #(lo_s_item#(8)) expfifo;
  uvm_tlm_analysis_fifo #(lo_s_item#(8)) outfifo;
