//----------------------------------------------------------------------
// This File: left_src_comparator.svh
...
class left_src_comparator extends uvm_component;
  `uvm_component_utils(left_src_comparator)

  left_src_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(left_src_item) exp_ap;
  uvm_analysis_export   #(left_src_item) out_ap;
  uvm_tlm_analysis_fifo #(left_src_item) expfifo;
  uvm_tlm_analysis_fifo #(left_src_item) outfifo;
