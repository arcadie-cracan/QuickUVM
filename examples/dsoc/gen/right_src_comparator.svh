//----------------------------------------------------------------------
// This File: right_src_comparator.svh
...
class right_src_comparator extends uvm_component;
  `uvm_component_utils(right_src_comparator)

  right_src_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(right_src_item) exp_ap;
  uvm_analysis_export   #(right_src_item) out_ap;
  uvm_tlm_analysis_fifo #(right_src_item) expfifo;
  uvm_tlm_analysis_fifo #(right_src_item) outfifo;
