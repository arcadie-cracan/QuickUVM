...
class dp_comparator extends uvm_component;
  `uvm_component_utils(dp_comparator)

  d_seq_item#(8) exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(d_seq_item#(8)) exp_ap;
  uvm_analysis_export   #(d_seq_item#(8)) out_ap;
  uvm_tlm_analysis_fifo #(d_seq_item#(8)) expfifo;
  uvm_tlm_analysis_fifo #(d_seq_item#(8)) outfifo;
