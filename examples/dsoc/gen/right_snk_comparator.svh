//----------------------------------------------------------------------
// This File: right_snk_comparator.svh
...
class right_snk_comparator extends uvm_component;
  `uvm_component_utils(right_snk_comparator)

  right_snk_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(right_snk_item) exp_ap;
  uvm_analysis_export   #(right_snk_item) out_ap;
  uvm_tlm_analysis_fifo #(right_snk_item) expfifo;
  uvm_tlm_analysis_fifo #(right_snk_item) outfifo;
