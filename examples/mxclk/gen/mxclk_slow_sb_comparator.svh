//----------------------------------------------------------------------
// This File: mxclk_slow_sb_comparator.svh
...
class mxclk_slow_sb_comparator extends uvm_component;
  `uvm_component_utils(mxclk_slow_sb_comparator)

  slow_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(slow_item) exp_ap;
  uvm_analysis_export   #(slow_item) out_ap;
  uvm_tlm_analysis_fifo #(slow_item) expfifo;
  uvm_tlm_analysis_fifo #(slow_item) outfifo;
