//----------------------------------------------------------------------
// This File: es_adaptp_comparator.svh
...
class es_adaptp_comparator extends uvm_component;
  `uvm_component_utils(es_adaptp_comparator)

  es_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(es_item) exp_ap;
  uvm_analysis_export   #(es_item) out_ap;
  uvm_tlm_analysis_fifo #(es_item) expfifo;
  uvm_tlm_analysis_fifo #(es_item) outfifo;
