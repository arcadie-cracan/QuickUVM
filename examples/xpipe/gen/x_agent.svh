...
class x_agent extends uvm_agent;
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    if (!uvm_config_db#(x_cfg)::get(this, "", "cfg", cfg))
      `uvm_fatal("NOCFG", {"No x_cfg set for: ", get_full_name()})
    is_active = cfg.is_active;
    vif       = cfg.vif;
    if (is_active == UVM_ACTIVE) begin
      drv = x_driver::type_id::create("drv", this);
      sqr = x_sequencer::type_id::create("sqr", this);
    end
    mon = x_monitor::type_id::create("mon", this);
    ap  = new("ap", this);
