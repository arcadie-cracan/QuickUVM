//----------------------------------------------------------------------
// This File: priority_encoder_comparator.svh
...
class priority_encoder_comparator extends uvm_component;
  `uvm_component_utils(priority_encoder_comparator)

  pe_seq_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(pe_seq_item) exp_ap;
  uvm_analysis_export   #(pe_seq_item) out_ap;
  uvm_tlm_analysis_fifo #(pe_seq_item) expfifo;
  uvm_tlm_analysis_fifo #(pe_seq_item) outfifo;
