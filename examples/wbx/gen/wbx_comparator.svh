...
class wbx_comparator extends uvm_component;
  `uvm_component_utils(wbx_comparator)

  cmd_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(cmd_item) exp_ap;
  uvm_analysis_export   #(cmd_item) out_ap;
  uvm_tlm_analysis_fifo #(cmd_item) expfifo;
  uvm_tlm_analysis_fifo #(cmd_item) outfifo;
