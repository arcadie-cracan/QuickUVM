//----------------------------------------------------------------------
// This File: regfile_comparator.svh
...
class regfile_comparator extends uvm_component;
  `uvm_component_utils(regfile_comparator)

  host_seq_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(host_seq_item) exp_ap;
  uvm_analysis_export   #(host_seq_item) out_ap;
  uvm_tlm_analysis_fifo #(host_seq_item) expfifo;
  uvm_tlm_analysis_fifo #(host_seq_item) outfifo;
