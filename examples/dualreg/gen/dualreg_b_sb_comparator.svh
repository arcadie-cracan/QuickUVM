//----------------------------------------------------------------------
// This File: dualreg_b_sb_comparator.svh
...
class dualreg_b_sb_comparator extends uvm_component;
  `uvm_component_utils(dualreg_b_sb_comparator)

  b_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(b_item) exp_ap;
  uvm_analysis_export   #(b_item) out_ap;
  uvm_tlm_analysis_fifo #(b_item) expfifo;
  uvm_tlm_analysis_fifo #(b_item) outfifo;
