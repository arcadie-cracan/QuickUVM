//----------------------------------------------------------------------
// This File: axi_read_burst_comparator.svh
...
class axi_read_burst_comparator extends uvm_component;
  `uvm_component_utils(axi_read_burst_comparator)

  rd_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(rd_item) exp_ap;
  uvm_analysis_export   #(rd_item) out_ap;
  uvm_tlm_analysis_fifo #(rd_item) expfifo;
  uvm_tlm_analysis_fifo #(rd_item) outfifo;
