...
class mac_comparator extends uvm_component;
  `uvm_component_utils(mac_comparator)

  m_seq_item#(16) exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(m_seq_item#(16)) exp_ap;
  uvm_analysis_export   #(m_seq_item#(16)) out_ap;
  uvm_tlm_analysis_fifo #(m_seq_item#(16)) expfifo;
  uvm_tlm_analysis_fifo #(m_seq_item#(16)) outfifo;
