//----------------------------------------------------------------------
// This File: mclk_io_sb_comparator.svh
...
class mclk_io_sb_comparator extends uvm_component;
  `uvm_component_utils(mclk_io_sb_comparator)

  io_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(io_item) exp_ap;
  uvm_analysis_export   #(io_item) out_ap;
  uvm_tlm_analysis_fifo #(io_item) expfifo;
  uvm_tlm_analysis_fifo #(io_item) outfifo;
