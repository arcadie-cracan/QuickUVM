//----------------------------------------------------------------------
// This File: pkt_sum_comparator.svh
...
class pkt_sum_comparator extends uvm_component;
  `uvm_component_utils(pkt_sum_comparator)

  stream_seq_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(stream_seq_item) exp_ap;
  uvm_analysis_export   #(stream_seq_item) out_ap;
  uvm_tlm_analysis_fifo #(stream_seq_item) expfifo;
  uvm_tlm_analysis_fifo #(stream_seq_item) outfifo;
