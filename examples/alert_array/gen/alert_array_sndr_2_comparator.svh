//----------------------------------------------------------------------
// This File: alert_array_sndr_2_comparator.svh
...
class alert_array_sndr_2_comparator extends uvm_component;
  `uvm_component_utils(alert_array_sndr_2_comparator)

  sndr_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(sndr_item) exp_ap;
  uvm_analysis_export   #(sndr_item) out_ap;
  uvm_tlm_analysis_fifo #(sndr_item) expfifo;
  uvm_tlm_analysis_fifo #(sndr_item) outfifo;
