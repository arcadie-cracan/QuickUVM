...
class a1_comparator extends uvm_component;
  `uvm_component_utils(a1_comparator)

  ga1_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(ga1_item) exp_ap;
  uvm_analysis_export   #(ga1_item) out_ap;
  uvm_tlm_analysis_fifo #(ga1_item) expfifo;
  uvm_tlm_analysis_fifo #(ga1_item) outfifo;
