...
class b1_comparator extends uvm_component;
  `uvm_component_utils(b1_comparator)

  gb1_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(gb1_item) exp_ap;
  uvm_analysis_export   #(gb1_item) out_ap;
  uvm_tlm_analysis_fifo #(gb1_item) expfifo;
  uvm_tlm_analysis_fifo #(gb1_item) outfifo;
