//----------------------------------------------------------------------
// This File: mclk_sys_sb_comparator.svh
...
class mclk_sys_sb_comparator extends uvm_component;
  `uvm_component_utils(mclk_sys_sb_comparator)

  sys_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(sys_item) exp_ap;
  uvm_analysis_export   #(sys_item) out_ap;
  uvm_tlm_analysis_fifo #(sys_item) expfifo;
  uvm_tlm_analysis_fifo #(sys_item) outfifo;
