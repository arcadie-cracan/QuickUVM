//----------------------------------------------------------------------
// This File: mxclk_fast_sb_comparator.svh
...
class mxclk_fast_sb_comparator extends uvm_component;
  `uvm_component_utils(mxclk_fast_sb_comparator)

  fast_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(fast_item) exp_ap;
  uvm_analysis_export   #(fast_item) out_ap;
  uvm_tlm_analysis_fifo #(fast_item) expfifo;
  uvm_tlm_analysis_fifo #(fast_item) outfifo;
