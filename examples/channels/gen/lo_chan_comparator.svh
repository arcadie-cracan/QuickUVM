//----------------------------------------------------------------------
// This File: lo_chan_comparator.svh
...
class lo_chan_comparator extends uvm_component;
  `uvm_component_utils(lo_chan_comparator)

  lo_c_seq_item#(8) exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(lo_c_seq_item#(8)) exp_ap;
  uvm_analysis_export   #(lo_c_seq_item#(8)) out_ap;
  uvm_tlm_analysis_fifo #(lo_c_seq_item#(8)) expfifo;
  uvm_tlm_analysis_fifo #(lo_c_seq_item#(8)) outfifo;
