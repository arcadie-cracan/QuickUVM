...
class fifo_comparator extends uvm_component;
  `uvm_component_utils(fifo_comparator)

  wr_seq_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(wr_seq_item) exp_ap;
  uvm_analysis_export   #(wr_seq_item) out_ap;
  uvm_tlm_analysis_fifo #(wr_seq_item) expfifo;
  uvm_tlm_analysis_fifo #(wr_seq_item) outfifo;
