//----------------------------------------------------------------------
// This File: ahb_regs_comparator.svh
...
class ahb_regs_comparator extends uvm_component;
  `uvm_component_utils(ahb_regs_comparator)

  ahb_seq_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(ahb_seq_item) exp_ap;
  uvm_analysis_export   #(ahb_seq_item) out_ap;
  uvm_tlm_analysis_fifo #(ahb_seq_item) expfifo;
  uvm_tlm_analysis_fifo #(ahb_seq_item) outfifo;
