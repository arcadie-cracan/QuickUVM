...
class b0_comparator extends uvm_component;
  `uvm_component_utils(b0_comparator)

  gb0_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(gb0_item) exp_ap;
  uvm_analysis_export   #(gb0_item) out_ap;
  uvm_tlm_analysis_fifo #(gb0_item) expfifo;
  uvm_tlm_analysis_fifo #(gb0_item) outfifo;
