//----------------------------------------------------------------------
// This File: nchan_ch_0_comparator.svh
...
class nchan_ch_0_comparator extends uvm_component;
  `uvm_component_utils(nchan_ch_0_comparator)

  ch_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(ch_item) exp_ap;
  uvm_analysis_export   #(ch_item) out_ap;
  uvm_tlm_analysis_fifo #(ch_item) expfifo;
  uvm_tlm_analysis_fifo #(ch_item) outfifo;
