//----------------------------------------------------------------------
// This File: cdc_fifo_base_test.svh
...
class cdc_fifo_base_test extends uvm_test;
  `uvm_component_utils(cdc_fifo_base_test)
  ...
  function void build_phase(uvm_phase phase);
    ...
    env_cfg = cdc_fifo_env_cfg::type_id::create("env_cfg");
    ...
    uvm_config_db#(cdc_fifo_env_cfg)::set(this, "e", "env_cfg", env_cfg);

    e = cdc_fifo_env::type_id::create("e", this);
  ...
  function void end_of_elaboration_phase(uvm_phase phase);
    ...
    `uvm_info("TB", "cdc_fifo_base_test: end_of_elaboration", UVM_FULL)
  endfunction
  ...
  function void start_of_simulation_phase(uvm_phase phase);
    ...
    `uvm_info("TB", "cdc_fifo_base_test: start_of_simulation", UVM_FULL)
  endfunction
