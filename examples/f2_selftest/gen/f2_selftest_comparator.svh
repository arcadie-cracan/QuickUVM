//----------------------------------------------------------------------
// This File: f2_selftest_comparator.svh
...
class f2_selftest_comparator extends uvm_component;
  `uvm_component_utils(f2_selftest_comparator)

  io_seq_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(io_seq_item) exp_ap;
  uvm_analysis_export   #(io_seq_item) out_ap;
  uvm_tlm_analysis_fifo #(io_seq_item) expfifo;
  uvm_tlm_analysis_fifo #(io_seq_item) outfifo;
