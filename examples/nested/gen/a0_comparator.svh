...
class a0_comparator extends uvm_component;
  `uvm_component_utils(a0_comparator)

  ga0_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(ga0_item) exp_ap;
  uvm_analysis_export   #(ga0_item) out_ap;
  uvm_tlm_analysis_fifo #(ga0_item) expfifo;
  uvm_tlm_analysis_fifo #(ga0_item) outfifo;
