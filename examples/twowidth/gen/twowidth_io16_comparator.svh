//----------------------------------------------------------------------
// This File: twowidth_io16_comparator.svh
...
class twowidth_io16_comparator extends uvm_component;
  `uvm_component_utils(twowidth_io16_comparator)

  io_seq_item#(16) exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(io_seq_item#(16)) exp_ap;
  uvm_analysis_export   #(io_seq_item#(16)) out_ap;
  uvm_tlm_analysis_fifo #(io_seq_item#(16)) expfifo;
  uvm_tlm_analysis_fifo #(io_seq_item#(16)) outfifo;
