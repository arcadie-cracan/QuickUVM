...
class mul_comparator extends uvm_component;
  `uvm_component_utils(mul_comparator)

  m_item exp_tr, out_tr;
  static int VECT_CNT, PASS_CNT, ERROR_CNT;

  uvm_analysis_export   #(m_item) exp_ap;
  uvm_analysis_export   #(m_item) out_ap;
  uvm_tlm_analysis_fifo #(m_item) expfifo;
  uvm_tlm_analysis_fifo #(m_item) outfifo;
